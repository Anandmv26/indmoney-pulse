document.addEventListener("DOMContentLoaded", () => {
    ...
    const elements = {
        ...
        feeSourcesList: document.getElementById("fee-sources-list"),
    ...
    function renderPayload(payload) {
        ...
        elements.feeSourcesList.innerHTML = payload.source_links.map(s => 
        ...
        elements.lastChecked.textContent = `Last checked: ${payload.last_checked}`;
    }
